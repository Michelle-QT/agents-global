...
SKILLS := standard-project standard-project-experiment add-escape pr-open pr-review pr-status where-are-we git write-document zotero proceed-autonomously open-threads
